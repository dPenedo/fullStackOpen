    ...
    <div style={blogStyle} className="blog" data-testid="blog-item">
      ...
      {visibility && (
        <div data-testid="hidden-info">
          ...
          <div>
            <b>Likes: </b>
            <span data-testid="blog-likes">{blog.likes}</span>{" "}
            <button data-testid="button-like" onClick={handleLikeClick}>
              Like
            </button>
          </div>
          {user.user && blog.user === user.user ? (
            <button style={deleteButtonStyle} onClick={handleDeleteButton}>
              Delete
            </button>
          ) : (
            <></>
